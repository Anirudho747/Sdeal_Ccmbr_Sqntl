...
/*    public void setUp()
    {
        ...
        try {
            ...
            dc.setCapability("deviceName","androidDevice");
            ...
            e.printStackTrace();
            System.out.println("Kuch fata");
        }

        System.out.println("bm");
    }

    public boolean launchApp(String platformName, String deviceName,String appActivity,
                             String automationName, String app) {
        try {
            DesiredCapabilities dc = new DesiredCapabilities();
            ...
            if (platformName.equalsIgnoreCase("Android")) {
                ...
                dc.setCapability("autoGrantPermissions", true);
                URL url= new URL("http://127.0.0.1:4723/wd/hub");
                //driver=(new ThreadLocal<AppiumDriver>().get());
                driver= new AndroidDriver(url,dc);
